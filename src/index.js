...
function renderNotFound() {
  return `<!doctype html>
<html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>チームが見つかりません | SIGN TRAINER</title><style>body{font-family:system-ui,sans-serif;background:#f4f7f9;color:#0d2945;margin:0;display:grid;min-height:100vh;place-items:center}.box{max-width:420px;background:#fff;border:1px solid #dbe4ea;border-radius:24px;padding:32px;text-align:center;box-shadow:0 18px 50px rgba(13,41,69,.08)}a{min-height:48px;padding:0 18px;display:inline-flex;align-items:center;justify-content:center;border-radius:12px;color:#fff;background:#087a4b;text-decoration:none;font-weight:800}</style></head><body><main class="box"><h1>チームが見つかりません</h1><p>URLが正しいか確認してください。</p><a href="/">トップページへ</a></main></body></html>`;
}
