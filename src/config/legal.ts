...
export function isValidPublicSupportUrl(value: unknown): boolean {
...
export function publicLegalConfig(env: Record<string, unknown> = {}) {
...
export function legalConsentMatches({ termsVersion, privacyVersion }: { termsVersion?: unknown; privacyVersion?: unknown } = {}) {
