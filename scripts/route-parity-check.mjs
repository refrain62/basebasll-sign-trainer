...
for (const needle of ['from "hono"', 'app.route("/api", playerRoutes)', 'app.route("/api/team-admin", teamAdminRoutes)', 'app.route("/api/system", systemRoutes)']) {
...
for (const file of ["src/routes/player.js", "src/routes/team-admin.js", "src/routes/system.js"]) {
